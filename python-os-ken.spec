...
install -p -D -m 640 bin/%{srcname}/%{binname}  %{buildroot}%{_bindir}/%{srcname}/%{binname}
install -p -D -m 640 bin/%{srcname}/%{binname}-manager  %{buildroot}%{_bindir}/%{srcname}/%{binname}-manager
